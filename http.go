...
const (
	...
	errorPackage   = protogen.GoImportPath("github.com/zouchunxu/gof/pkg/api_errors")
	responsePackage   = protogen.GoImportPath("github.com/zouchunxu/gof/pkg/responses")
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("var _ = ", responsePackage.Ident("New"))
	g.P("var _ = ", errorPackage.Ident("New"))
